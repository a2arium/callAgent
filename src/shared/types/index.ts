...
export type TaskContext = {
    ...
    memory: { get: <T = unknown>(key: string) => Promise<T | null>; set: <T = unknown>(key: string, value: T) => Promise<void>; query: <T = unknown>(opts: unknown) => Promise<Array<{ key: string; value: T }>>; delete: (key: string) => Promise<void>; };
