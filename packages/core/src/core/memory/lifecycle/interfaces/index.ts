...
// Stage-specific component interfaces (with explicit naming to avoid conflicts)
export type {
    IAcquisitionFilter,
    IInformationCompressor,
    IExperienceConsolidator,
} from '../1-acquisition/interfaces/index.js';

export type {
    ISelectiveAttention,
    IMultiModalFusion,
} from '../2-encoding/interfaces/index.js';
...
export type {
    ...
    IKnowledgeDistiller,
    ISelectiveForgetter,
} from '../3-derivation/interfaces/index.js';

export type {
    IIndexingOrchestrator,
    IMatchingStrategy,
} from '../4-retrieval/interfaces/index.js';

export type {
    IAssociativeMemory as IAssociativeMemoryComponent,
    IParameterIntegration as IParameterIntegrationComponent,
} from '../5-neural-memory/interfaces/index.js';

export type {
    IRAGOrchestrator,
    ILongContextManager,
    IHallucinationMitigator,
} from '../6-utilization/interfaces/index.js';
