import type { AgentManifest, AgentTaskContext } from '../../shared/types/index.js';
...
export type AgentPlugin = {
    ...
    tenantId: string;
    loop?: {
        modules?: Partial<import('../../loop/oneTurn.js').Modules>;
    };
};
/**
...
export type CreateAgentPluginOptions<Sensory = unknown, Obs = unknown> = {
    ...
    tenantId?: string;
    loop?: {
        modules?: Partial<import('../../loop/oneTurn.js').Modules<Sensory, Obs>>;
    };
